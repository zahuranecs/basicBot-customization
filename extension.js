(function () {
    ...
    localStorage.setItem("basicBotsettings", JSON.stringify({
        ...
        intervalMessages: ["Be sure to leave a woot for your fellow DJs","Please let us know if we are doing a good job!","Please keep your songs to the current theme, which is: METAL MONDAY"],
        messageInterval: 10,
        songstats: true,
        commandLiteral: "!",
        blacklists: {
